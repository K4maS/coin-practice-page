...
const publicPath = '/coin-practice-page/';
// Список адресов для перехода между страниами
const loginAddress = publicPath + 'login';
const accountsListAddress = publicPath + 'accounts-list';
const accountAddress = publicPath + 'account';
const balanceHistoryAddress = publicPath + 'balance';
const currencyAddress = publicPath + 'currency';
const atmAddress = publicPath + 'atms';
...
const js_router = new (navigo_min_default())('/');
