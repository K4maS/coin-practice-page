...
const loginAddress = '/';
const accountsListAddress = 'accounts-list';
const accountAddress = 'account';
const balanceHistoryAddress = 'balance';
const currencyAddress = 'currency';
const atmAddress = 'atms';
...
const js_router = new (navigo_min_default())('/coin-practice-page/');
